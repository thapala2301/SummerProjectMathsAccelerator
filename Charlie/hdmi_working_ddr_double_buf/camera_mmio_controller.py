...
WINDOW_HEIGHT = 600
WINDOW_TITLE = "ctrls"
SERVER_ADDR = ("192.168.137.238", 9999)
...
def get_camera_matrix(yaw, pitch):
    ...
    # ray_gen computes world_dir = M * local_dir, so send the camera basis as
    # matrix columns: right, up, forward. The forward column is direct because
    # the FPGA uses positive local Z for the centre ray.
    return [
