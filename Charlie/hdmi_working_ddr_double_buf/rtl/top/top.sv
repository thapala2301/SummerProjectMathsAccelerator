...
logic [31:0] writer_debug_status;
...
always_comb begin
    if (!frame_base_valid) begin
        debug_state = 4'h0;
    end else if (frame_ready_valid) begin
        debug_state = 4'h6;
    end else if (frame_drain_wait || writer_fifo_almost_full) begin
        debug_state = 4'h5;
...
ddr_rgb_writer #(
    ...
    .debug_status(writer_debug_status)
);
