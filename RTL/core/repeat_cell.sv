...
//FP27 representations of cell boundaries
/*
The max march distance is ~250 units, 
so need one entry per 10-unit cell out to 260. 
ie, 26 entries.
one big priority encoder,  comb, fast.
*/
...
assign in_range_next = (abs_p < THRESHOLDS[NUM_REPEAT_BANDS - 1]);//obtain by how many we should sub or add to get coordinates within canonical cell
