...
proc create_root_design { parentCell } {
  ...
  set cam_origin_right_flat [ create_bd_port -dir O -from 80 -to 0 cam_origin_right_flat ]
  ...
  # Create instance: axi_iic_0 (MPU-9250 on Arduino header SDA/SCL)
  set axi_iic_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_iic:2.1 axi_iic_0 ]

  # Create external IIC port (maps to Arduino header W16/V16 via XDC)
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins axi_iic_0/S_AXI]
  ...
  connect_bd_net -net axi_camera_regs_ip_0_cam_origin_right_flat  [get_bd_pins axi_camera_regs_ip_0/cam_origin_right_flat] \
  [get_bd_ports cam_origin_right_flat]
  ...
  connect_bd_net -net frame_ready_bank_1  [get_bd_ports frame_ready_bank] \
  [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net frame_ready_valid_1  [get_bd_ports frame_ready_valid] \
  ...
  set_property CONFIG.ASSOCIATED_BUSIF {S00_AXI} [get_bd_pins axi_camera_regs_ip_0/s00_axi_aclk]
