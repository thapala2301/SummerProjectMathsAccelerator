module top #(
    ...
    input  logic [3*FP_W-1:0] cam_origin_right_flat,
    ...
    output logic       frame_ready_valid,
    output logic       frame_ready_bank,
...
generate
    ...
    for (g = 0; g < 3; g++) begin : gen_origin_right_unpack
        assign cam_origin_right[g] = cam_origin_right_flat[g*FP_W +: FP_W];
    end
endgenerate
...
always_ff @(posedge sys_clk) begin
    if (rst) begin
        ...
        if (frame_ready_valid && frame_ack) begin
            frame_ready_valid <= 1'b0;
