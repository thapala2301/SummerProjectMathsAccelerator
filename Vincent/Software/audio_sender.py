...
Sends 8 floats to PYNQ via TCP port 9998
'''
...
import threading
import math
PYNQ_IP     = "192.168.2.99"  # replace with your PYNQ's IP
PYNQ_PORT   = 9998
...
def audio_callback(indata, frames, time, status):
    ...
    #smooth / lerp EMA, followed by clampinging 
    ...
    pos_z = R*math.cos(t)
    #write all 8 sdf params + camera posn ---
    # pack final scene values and send to PYNQ
